...
# ==========================================
INPUT_FILE = '5.csv'
OUTPUT_FILE = 'synthetic_datasets/bad_datasets/datasets_without_marks/synthetic_datasets_contact_degradation/synthetic_datasets_contact_degradation5.csv'
N_ROWS = 10000
...
anom_cols = cols
#раскомментировать если нужны метки
